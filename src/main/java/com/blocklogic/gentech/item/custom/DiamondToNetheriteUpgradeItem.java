...
public class DiamondToNetheriteUpgradeItem extends Item {
    public DiamondToNetheriteUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("tooltip.gentech.tier_upgrade.diamond_to_netherite")
        ...
        tooltipComponents.add(Component.translatable("tooltip.gentech.tier_upgrade.upgrade_slot", "3")
