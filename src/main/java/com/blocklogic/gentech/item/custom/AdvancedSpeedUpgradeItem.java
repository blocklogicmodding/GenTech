...
public class AdvancedSpeedUpgradeItem extends Item {
    public AdvancedSpeedUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        double multiplier = Config.getAdvancedSpeedUpgradeMultiplier();
