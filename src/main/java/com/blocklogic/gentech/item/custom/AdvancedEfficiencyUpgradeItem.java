...
public class AdvancedEfficiencyUpgradeItem extends Item {
    public AdvancedEfficiencyUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        double reduction = Config.getAdvancedEfficiencyUpgradeReduction() * 100;

        tooltipComponents.add(Component.translatable("tooltip.gentech.efficiency_upgrade.advanced")
