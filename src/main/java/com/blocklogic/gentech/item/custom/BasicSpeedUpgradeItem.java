...
public class BasicSpeedUpgradeItem extends Item {
    public BasicSpeedUpgradeItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        double multiplier = Config.getBasicSpeedUpgradeMultiplier();
        double speedIncrease = (multiplier - 1.0) * 100;
        double timeReduction = (1.0 - (1.0 / multiplier)) * 100;

        tooltipComponents.add(Component.translatable("tooltip.gentech.speed_upgrade.basic")
